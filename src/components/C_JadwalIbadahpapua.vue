    ...
    <v-row>
      <v-col md="10" offset-md="1">
        ...
        <v-card-actions>
          ...
          <span class="ml-5">{{ rows.date }}</span>
          <v-spacer></v-spacer>
        ...
        rows: [
          {
            ...
            content:
              ...
              <img style="width:100%; padding:20px" src='https://www.facebook.com/photo/?fbid=10212986205908211&set=p.10212986205908211'/> 
              <br/>
              <i>GPI Jalan Suci Jayapura</i>, 
              <span style="color:red">Tanah Hitam</span>
            `
          },
          {
            id: "2366",
